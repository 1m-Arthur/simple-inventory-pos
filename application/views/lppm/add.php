                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-body card-block">
                            ...
                            <?php echo form_open('lppm/addAction/'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="nf-password" name="qty" placeholder="Enter Quantity.." class="form-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <select name="satuan" id="select" class="form-control" required>
                                    <?php foreach ($satuan as $satuans) { ?>
                                        <option value=" <?php echo $satuans['satuan_id'] ?>"><?php echo $satuans['nama_satuan'] ?></option>
                                    <?php
                                } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input datetimepicker-input1" id="datetimepicker5" data-toggle="datetimepicker" data-target="#datetimepicker5" name="created_date" required />
                            ...
                            <div class="form-group">
                                ...
                                <!-- <input type="text" id="datepicker" name="tgl_diperlukan" class="form-control" required> -->
                                <div class="input-group date" id="datepicker" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input date2" id="datepicker" data-toggle="datetimepicker" data-target="#datepicker" name="tgl_diperlukan" required />
                                    <div class="input-group-append" data-target="#datepicker" data-toggle="datetimepicker">
                                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
                                <?php echo form_error('tgl_diperlukan', '<span class="help-block text-danger">', '</span>'); ?>
                            </div>
