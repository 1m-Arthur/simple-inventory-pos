                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-body card-block">
                            <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <?php echo form_open('lppm/Approve/' . $view['pekerjaan_id']); ?>
                                        <div class="modal-body">
                                            <strong>
                                                <p style="padding-bottom:15px;padding-top:35px;">
                                                    Apakah anda yakin ingin melakukan approve?<br>
                                                </p>
                                            ...
                                            <div class="form-group">
                                                <label for="nf-password" class=" form-control-label">Tanggal Approve</label>
                            ...
                            <div class="form-group">
                                <label for="nf-username" class=" form-control-label">LPPM:</label>
                                <input type="text" id="nf-password" value="<?php echo $view['lppm_no'] ?>" name="lppm_no" placeholder="Barang belum diajukan" class="form-control" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <!-- <?php if ($view['tgl_terima'] !== null) { ?>
                                                                                            <tr>
                                                                                                <th scope="row">5</th>
                                                                                                <td><?php echo $status[4]['nama_disposisi'] ?></td>
                                                                                                <td><?php echo date('d/M/Y (H:i)', strtotime($view['tgl_terima'])) ?></td>
                                                                                            </tr>
                                        <?php
                                    } ?> -->
                            ...
                            <div class="form-actions form-group">
                                <?php if ($view['disposisi_id'] == '2') { ?>
                                    <a class="btn btn-danger btn-sm" href="<?php echo base_url('lppm/Reject/' . $view['pekerjaan_id']); ?>"> Reject</a>
