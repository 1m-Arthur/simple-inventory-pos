                    ...
                    <div class="card-body">
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nf-password" value="<?php echo (isset($user['first_name'])) ? $user['first_name'] . ' ' . $user['last_name'] : "Barang belum diterima"; ?>" name="bahan" placeholder="Enter Bahan.." class="form-control" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="nf-password" class=" form-control-label">Tanggal Diterima</label>
                                <input type="text" id="nf-password" value="<?php echo ($view['tgl_penerimaan'] !== null) ? date('d-M-Y', strtotime($view['tgl_penerimaan'])) : "Barang belum diterima"; ?>" name="tgl_penerimaan" placeholder="Enter Tanggal Diterima.." class="form-control" disabled>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-addon"><?php echo $view['qty'] ?></div>
